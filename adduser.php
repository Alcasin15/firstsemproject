...
<body>
    ...
    <label for="">User Name</label><br>
        <input type="text" name="username" required placeholder="User Name" size="35"><br><br>
        <label for="">Password </label><br>
        <input type="password" name="password" required placeholder="Password" ><br><br>
        <label for="">Nickname </label><br>
        <input type="text" name="nickname" required placeholder="Nickname"><br><br>
        
        <input type = "submit" class="btn btn-success" name = "adduser" value = "REGISTER">
